...
```sh
pnpx expo install expo@next --fix  # install beta
```
...
```sh
pnpx expo install expo@latest
pnpx expo install --fix
```

2. Run diagnostics: `pnpx expo-doctor`

3. Clear caches and reinstall

```sh
pnpx expo export -p ios --clear
...
- Clear derived data for Xcode: `pnpx expo run:ios --no-build-cache`
